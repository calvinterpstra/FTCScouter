        ...
        <div style={styles.root}>
          <div style={{textAlign: 'center', marginLeft: ((width*0.5)-150)}}>
            ...
            <div style={{ height: 90, width: 130, margin: 0, textAlign: 'center', display: 'inline-block'}}>
              <p style={{marginTop: 5, marginBottom: 5}}>{"Particles Scored: " + this.props.scores.autonCenterVortexScore1/15}</p>
              <div>
                <RaisedButton
                  label="-"
                  secondary={true}
          ...
          <div style={{textAlign: 'center'}}>
            ...
            <div style={{ height: 90, width: 130, margin: 0, textAlign: 'center', display: 'inline-block' }}>
              <p style={{marginTop: 5, marginBottom: 5}}>{"Particles Scored: " + this.props.scores.autonCenterVortexScore2/15}</p>
              <div>
                <RaisedButton
                  label="-"
                  secondary={true}
