...
var TeamsMatchList = React.createClass({
    ...
    render() {
        ...
        var matchList = matches.map(function (match, i) {
            ...
            if (this.props.selectedCompetition.name == match.competition) {
        ...
        const compOnlyMatches = this.props.getMatcheswithTeamNumberInCompetition(this.props.currentTeam.teamNumber, this.props.selectedCompetition.name);
        var dataCalculator = new DataCalculator(compOnlyMatches);
        const averageMatchScore = Math.round(dataCalculator.getAverageMatchScoreForTeam(this.props.currentTeam.teamNumber));
