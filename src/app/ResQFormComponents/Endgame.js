...
import EndgameMountain from './EndgameMountain';
import AllClearSignal from './AllClearSignal';
        ...
        return (
            <MuiThemeProvider muiTheme={muiTheme}>
                <div>
                    ...
                    <EndgameMountain scores = {this.props.scores} handleScoreChange = {this.props.handleScoreChange}
                        team1={this.props.team1} team2={this.props.team2}/>
                    
                    <AllClearSignal scores = {this.props.scores} handleScoreChange = {this.props.handleScoreChange}
                        team1={this.props.team1} team2={this.props.team2}/>
                </div>
            </MuiThemeProvider>
        );
